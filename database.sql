...
INSERT INTO comic_cult.comic_book (title,isbn,date_of_release,pitch,keywords,nb_pages,volume,price,cover,author_name,category_id,user_id) VALUES
	 ...
	 ('Sentimental color',9782353255108,'2013-05-01','Les sentiments ont toutes sortes de couleurs. Quelle est la couleur des vôtres ?','les sentiments ont toutes sortes de couleurs  quelle est la couleur des votres',48,1,13.9,'https://www.bdtheque.com/repupload/T/T_48825.JPG','Yoon-Jeong',24,NULL),
	 ('60 ans d''humour',9782344000656,'2014-04-01','Recueil de gags de Quino pour l''anniversaire de ses 60 ans de carrière.','recueil de gags de quino pour l anniversaire de ses 60 ans de carriere',141,1,12.75,'https://www.bdtheque.com/repupload/T/T_56673.JPG','Quino',5,NULL);
INSERT INTO comic_cult.comic_book (title,isbn,date_of_release,pitch,keywords,nb_pages,volume,price,cover,author_name,category_id,user_id) VALUES
