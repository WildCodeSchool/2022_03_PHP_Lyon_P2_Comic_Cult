...
INSERT INTO comic_cult.comic_book (title,isbn,date_of_release,pitch,keywords,nb_pages,volume,price,cover,author_name,category_id,user_id) VALUES
	 ('Franky Snow - Slide à mort',9782723427593,'1999-10-19','Franky Snow est un vrai rider. Snowboard, surf, ski, skate, BMX, roller, VTT extrême, flyboard… cela tout en draguant les filles au passage si possible !','franky snow vrai rider snowboard surf ski skate bmx roller vtt extreme flyboard cela tout draguant  filles passage possible',48,1,10.95,'https://blog.manawa.com/wp-content/uploads/2020/12/Franky-Snow-nr-1.jpeg','',5,NULL),
